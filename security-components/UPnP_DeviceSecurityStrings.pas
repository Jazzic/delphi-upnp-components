...
const
  ...
  _PermsNamespaceFmtValue      = 'mfgr="%s"';
  _Owners                      = 'Owners';
  _profiles                    = 'Profiles';
  _ACL                         = 'acl';
  _entry                       = 'entry';
...
//  _dsSignatureXmlNS            = 'xmlns="http://www.w3.org/2000/09/xmldsig#"';
  _dsSignatureXmlNSValue       = '"http://www.w3.org/2000/09/xmldsig#"';
  _dsReference                 = 'Reference';
  _dsDigestValue               = 'DigestValue';
//  _dsCanonicalAlgorithm        = 'Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"';
  _dsCanonicalAlgorithmValue   = '"http://www.w3.org/2001/10/xml-exc-c14n#"';
...
//  _dsSignatureAlgorithm1       = 'Algorithm="http://www.w3.org/2000/09/xmldsig#hmac-sha1"';
  _dsSignatureAlgorithm1Value  = '"http://www.w3.org/2000/09/xmldsig#hmac-sha1"';
//  _dsSignatureAlgorithm2       = 'Algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1"';
  _dsSignatureAlgorithm2Value  = '"http://www.w3.org/2000/09/xmldsig#rsa-sha1"';
//  _dsReferenceURIAttr          = 'URI="%s"';
  _dsReferenceURIAttrValue     = '"%s"';
  _dsDigestMethod              = 'DigestMethod';
//  _dsDigestAlgorithm           = 'Algorithm="http://www.w3.org/2000/09/xmldsig#sha1"';
  _dsDigestAlgorithmValue      = '"http://www.w3.org/2000/09/xmldsig#sha1"';
  _dsKeyInfo                   = 'KeyInfo';
